...
public static class HostGuardSettingsPanel
{
    ...
    public static GameObject Create(Transform parent)
    {
        ...
        CreateTextRow(content.transform, "Exact Match Names (comma-separated)", HostGuardConfig.BadNameWords, ref y);
        ...
        CreateTextRow(content.transform, "Exact Match List (comma-separated)", HostGuardConfig.BannedWords, ref y);
        CreateTextRow(content.transform, "Contains List (comma-separated)", HostGuardConfig.BannedWordsContains, ref y);
